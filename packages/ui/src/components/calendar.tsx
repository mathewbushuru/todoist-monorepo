  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today: "bg-muted/80 text-white",
        day_outside:
          "day-outside text-white opacity-50 aria-selected:bg-muted/50 aria-selected:text-white aria-selected:opacity-30",
        day_disabled: "opacity-50",
        day_range_middle: "aria-selected:bg-muted/20 aria-selected:text-white",
